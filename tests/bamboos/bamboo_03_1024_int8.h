#ifndef BAMBOO_03_1024_H_
#define BAMBOO_03_1024_H_
...
#define BAMBOO_03_1024_NUM_CELLS 2048
#define BAMBOO_03_1024_SAMPLERATE 16384

CONSTTABLE_STORAGE(int8_t) BAMBOO_03_1024_DATA []  = {1, 1, -1, -1, 0, -1, 0, -1, -1, 2,
